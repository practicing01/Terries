...
Blind::Blind(Context* context, Urho3DPlayer* main, float duration) :
...
void Blind::Start()
{
	...
	//SubscribeToEvent(E_GETCLIENTGRAVITY, HANDLER(Blind, HandleGetBlind));
}
...
{/*
	...
	if (clientNode == node_)
	{
		...
		vm[SetClientBlind::P_GRAVITY] = gravity_;
		SendEvent(E_SETCLIENTGRAVITY, vm);
	}*/
}

void Blind::Update(float timeStep)
{
